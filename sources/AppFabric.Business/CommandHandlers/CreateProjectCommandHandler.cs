...
namespace AppFabric.Business.CommandHandlers
{
    public class CreateProjectCommandHandler : CommandHandler<CreateProjectCommand, CommandResult<Guid>>
    {
        ...
        public CreateProjectCommandHandler(ILogger<CreateProjectCommandHandler> logger, IMediator publisher, IDbSession<IProjectRepository> dbSession)
        ...
        protected override CommandResult<Guid> ExecuteCommand(CreateProjectCommand command)
        {
