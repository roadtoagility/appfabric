...
{
    public sealed class AppFabricProjectionsDbContext : AggregateDbContext
    {
        public AppFabricProjectionsDbContext(DbContextOptions<AppFabricProjectionsDbContext> options)
            : base(options)
        {
        }
